...
export const useTypewriter = (options: UseTypewriterOptions = {}): UseTypewriterReturn => {
  ...
  // Create stable typewriter instance - only create once and never recreate
  ...
  const metrics = useMemo(
    ...
    [
      typewriterState.segments.length,
  ...
  const TypewriterCursor = memo(() => {
    ...
    const cursorStyle = useMemo((): React.CSSProperties => {
      ...
      typewriterState.cursorVisible,
      typewriterState.reducedMotion,
    ]);
